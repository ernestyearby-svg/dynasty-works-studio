import { serviceCatalog } from "@legacy/data/service-catalog";
...
import {
  ...
  marketEntryStages,
  retailDeliverables,
} from "@legacy/data/company-builder";
import { practices, serviceRelationships } from "@legacy/data/practices";
import { engagementLevels, type StudioPackage } from "@legacy/data/offerings";
import type { VerifiedProof, MarketCaseSection } from "@legacy/types/company";
import { approvedMarketSections } from "@legacy/types/company";
