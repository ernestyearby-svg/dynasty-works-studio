...
import { AutomationPlan } from "@legacy/components/automation";
import { BrandProgression } from "@legacy/components/brand-progression";
import { founderBlueprint } from "@legacy/data/founder-blueprint";
import { BlueprintCTA } from "@legacy/components/blueprint-actions";
import Link from "@legacy/components/site-link";
import { generateRoadmap } from "@legacy/lib/recommendation-engine";
import { serviceById, boundaryCopy } from "@legacy/data/service-catalog";
import { preliminaryNotice } from "@legacy/data/packages";
import { templates } from "@legacy/data/templates";
