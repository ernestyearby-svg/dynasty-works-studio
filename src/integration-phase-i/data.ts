...
export const candidateSlugs=['object-zero','living-canvas','sovereign-os','signal','form','surface-structure','capital','orchestration','space'];
export const studyHref=(i:number)=>'/capabilities/'+candidateSlugs[i];
